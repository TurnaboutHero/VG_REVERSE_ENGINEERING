...
- [ ] Step1: Red-first tests for true boundaries and timestamps. The fixture packer is independent:
...
- [ ] Step2: Implement the iterator's frame walk. Use memoryview and checked bounds; each iteration starts exactly at the preceding end.
