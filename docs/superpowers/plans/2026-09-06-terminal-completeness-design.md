...
- M6 remains a 1486s max_death approximate estimate in v2, but completion is unknown and final KDA/winner/gold are withheld by the existing policy. Identity fields remain accepted. M9 remains incomplete.
